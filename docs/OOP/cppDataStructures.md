...
![Legend]({{site.baseurl}}/assets/cpp/Legend.png)

![DataStructures]({{site.baseurl}}/assets/cpp/Data%20Structures.png "Data Structures")

![ComplexityChart]({{site.baseurl}}/assets/cpp/Complexity%20Chart.png "Complexity Chart")

![DataStructureSelection]({{site.baseurl}}/assets/cpp/Data%20Structures%20Selection.png "Data Structures Selection")
-------------------------------------------------------
...
![MaxHeap]({{site.baseurl}}/assets/cpp/MaxHeap.png)
-------------------------------------------------------
## 2.0 Trees
### 2.1 Binary Tree
...
![BinarySearchTree]({{site.baseurl}}/assets/cpp/BinarySearchTree.png)
-------------------------------------------------------
### 2.2 Balanced Trees
...
![BinarySearch]({{site.baseurl}}/assets/cpp/Binary%20Search.gif "Binary Search")
-------------------------------------------------------
...
![DepthFirstSearch]({{site.baseurl}}/assets/cpp/Depth-First%20Search.gif "Depth-First Search")
-------------------------------------------------------
...
![DepthFirstSearch]({{site.baseurl}}/assets/cpp/Breadth-First%20Search.gif "Breadth-First Search")
-------------------------------------------------------
...
![InsertionSort]({{site.baseurl}}/assets/cpp/Insertion%20Sort.gif "Insertion Sort")
-------------------------------------------------------
### 4.2 Selection Sort
#### Idea
1. Iterate over all elements
...
![SelectionSort]({{site.baseurl}}/assets/cpp/Selection%20Sort.gif "Selection Sort")

![SelectionSort]({{site.baseurl}}/assets/cpp/Selection%20Sort%202.gif "Selection Sort 2")
-------------------------------------------------------
### 4.3 Bubble Sort
#### Idea
1. Iterate over all elements
...
![BubbleSort]({{site.baseurl}}/assets/cpp/Bubble%20Sort.gif "Bubble Sort")
-------------------------------------------------------
### 4.4 Merge Sort
#### Idea
...
![MergeSort]({{site.baseurl}}/assets/cpp/Merge%20Sort.gif "Merge Sort")

![MergeSort]({{site.baseurl}}/assets/cpp/Merge%20Sort%202.gif "Merge Sort 2")
-------------------------------------------------------
### 4.5 Quicksort
#### Idea
...
![QuickSort]({{site.baseurl}}/assets/cpp/Quicksort.gif)
